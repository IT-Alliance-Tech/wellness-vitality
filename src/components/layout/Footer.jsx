          ...
          <div className="lg:col-span-4">
            ...
            <div className="flex gap-4">
              {[
                ...
                { name: 'TikTok', icon: <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M9 3v12.5a2.5 2.5 0 11-2.5-2.5h.5V10h-.5a5 5 0 105 5V8.7c.9.6 2 .9 3.1.9V6.5c-.9 0-1.8-.3-2.5-.9-.7-.6-1.2-1.4-1.4-2.3H9z"/></svg> },
              ...
              <li className="flex gap-4 text-white/70 text-sm items-start">
                ...
                <div className="pt-1.5">
                  <div className="text-xs leading-relaxed text-white">
                    <span className="font-semibold">Mobile:</span> <span className="font-semibold font-bold">6 AM – 9 PM</span> <br />
                    <span className="font-semibold">Office:</span> <span className="font-semibold font-bold">9 AM – 6 PM</span>
                  </div>
                </div>
              </li>
              <li className="flex gap-4 text-white/70 text-sm items-start">
