      ...
      <div className="w-full px-4 sm:px-6 lg:px-12 xl:px-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-4">
            <Link href="/" className="inline-block mb-6">
              <img src="/logo.png" alt="Wellness Vitality Australia" className="h-20 w-auto" />
            </Link>
            ...
            <ul className="space-y-5">
              <li className="flex gap-4 text-white/70 text-sm items-start">
                ...
                <div className="pt-1.5">
                  ...
                  <div className="text-xs mt-0.5 opacity-80">Mon-Sun: 8am - 8pm</div>
                </div>
              </li>
              <li className="flex gap-4 text-white/70 text-sm items-start">
                <div className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center flex-shrink-0">
        ...
        <div className="border-t border-white/10 pt-8 mt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-white/40 text-xs font-medium">
            Â© {new Date().getFullYear()} Wellness & Vitality Australia. All rights reserved.
          </p>
