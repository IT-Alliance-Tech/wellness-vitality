...
const Hero = () => {
  return (
    <section
      className="relative pt-28 lg:pt-40 pb-0 lg:pb-20 overflow-hidden"
    ...
    >
      <div className="w-full px-6 lg:px-12 xl:px-16 pt-4 pb-0 lg:pb-8 relative z-10 text-center lg:text-left">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            {/* HEADING */}
            <h1
              className="text-[2.6rem] sm:text-[3rem] lg:text-[3.2rem] font-medium leading-[1.05] mb-6 !text-white"
      ...
      {/* RIGHT IMAGE (DESKTOP) */}
      <div className="absolute right-0 -bottom-4 w-[55%] h-full hidden lg:flex items-end justify-end pointer-events-none pr-[3%]">
        <Image
          src={HeroImage}
          alt="Healthcare Professionals"
          className="w-auto h-[90%] max-w-none object-contain object-bottom"
          width={1000}
          height={700}
          priority
        />
